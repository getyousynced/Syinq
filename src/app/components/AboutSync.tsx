      ...
      <div className="w-full flex justify-center">
        <div className="w-full max-w-7xl">
          ...
          <div className="flex justify-center lg:justify-start">
            <nav
              className=" w-[75%] sm:w-[80%] lg:w-[50%] xl:w-[36%] rounded-3xl p-1 px-2 sm:px-4 lg:px-8 drop-shadow-xl flex justify-between relative overflow-x-auto"
              role="navigation"
                  ...
                  aboutSectionContent
                    ...
                    .map(({ id, contHeading, contText }) => (
                      ...
                      >
                        ...
                        <div className="mt-3 sm:mt-5 whitespace-pre-line">
                          <TextGenerateEffect
                            duration={2}
                            filter={false}
                            words={contText}
