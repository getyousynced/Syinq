...
export default function AdminRegister() {
  ...
  const handleSubmit = async (e: any) => {
    ...
    if (!email.endsWith("@syinq.com")) {
      toast.error("Only @syinq.com email addresses are allowed");
      return;
    }

    console.log("🟡 [Register] Form submitted");
    console.log("🟡 [Register] Sending data to backend /admin/auth/register");
  ...
  return (
    ...
    >
      ...
      <div className="bg-white rounded-lg shadow-lg p-8 w-full max-w-lg">
        <h1 className="text-2xl font-bold text-center mb-2">Admin Register</h1>
        ...
        <form onSubmit={handleSubmit}>
          ...
          <div className="mb-2">
            ...
            <input
              ...
              pattern="^[a-zA-Z0-9._%+-]+@syinq\\.com$"
              title="Email must be a @syinq.com address"
              className="w-full px-4 py-3 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent"
              required
            />
          </div>
