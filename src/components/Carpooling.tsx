            ...
            <div className="space-y-6 mt-8">
              <div className="flex items-start">
                ...
                <div>
                  ...
                  <p className="text-syinq-gray">
                    Based on time, route & gender preferences for optimal ride
                    coordination.
                  </p>
                </div>
              </div>
              ...
              <div className="flex items-start">
                ...
                <div>
                  ...
                  <p className="text-syinq-gray">
                    Schedule repeating journeys that match your weekly class
                    timetable.
                  </p>
                </div>
              </div>
              ...
              <div className="flex items-start">
                ...
                <div>
                  ...
                  <p className="text-syinq-gray">
                    Flexible payment options to share costs or charge your own
                    rates.
                  </p>
                </div>
              </div>
              ...
              <div className="flex items-start">
                ...
                <div>
                  ...
                  <p className="text-syinq-gray">
                    Travel with confidence knowing all drivers are vetted and
                    verified.
                  </p>
                </div>
              </div>
                  ...
                  <div className="p-4">
                    <div className="space-y-4">
                      <div className="bg-syinq-lightgray p-4 rounded-xl flex items-center space-x-4">
                        <div className="w-10 h-10 bg-syinq-blue rounded-full flex items-center justify-center text-white font-semibold">
                          S
                        </div>
                        <div>
