 ...
 * ```
 */
export declare function getQuicksightAnalysisOutput(args: GetQuicksightAnalysisOutputArgs, opts?: pulumi.InvokeOptions): pulumi.Output<GetQuicksightAnalysisResult>;
/**
 * A collection of arguments for invoking getQuicksightAnalysis.
 */
