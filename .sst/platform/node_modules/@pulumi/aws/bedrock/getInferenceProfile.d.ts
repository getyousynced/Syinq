 ...
 * ```
 */
export declare function getInferenceProfileOutput(args: GetInferenceProfileOutputArgs, opts?: pulumi.InvokeOptions): pulumi.Output<GetInferenceProfileResult>;
/**
 * A collection of arguments for invoking getInferenceProfile.
 */
