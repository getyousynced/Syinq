 ...
 * ```
 */
export declare function getAgentAgentVersionsOutput(args: GetAgentAgentVersionsOutputArgs, opts?: pulumi.InvokeOptions): pulumi.Output<GetAgentAgentVersionsResult>;
/**
 * A collection of arguments for invoking getAgentAgentVersions.
 */
