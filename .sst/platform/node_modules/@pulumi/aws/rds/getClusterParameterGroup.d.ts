 ...
 * ```
 */
export declare function getClusterParameterGroupOutput(args: GetClusterParameterGroupOutputArgs, opts?: pulumi.InvokeOptions): pulumi.Output<GetClusterParameterGroupResult>;
/**
 * A collection of arguments for invoking getClusterParameterGroup.
 */
