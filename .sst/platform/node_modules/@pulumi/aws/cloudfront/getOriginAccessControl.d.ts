 ...
 * ```
 */
export declare function getOriginAccessControlOutput(args: GetOriginAccessControlOutputArgs, opts?: pulumi.InvokeOptions): pulumi.Output<GetOriginAccessControlResult>;
/**
 * A collection of arguments for invoking getOriginAccessControl.
 */
