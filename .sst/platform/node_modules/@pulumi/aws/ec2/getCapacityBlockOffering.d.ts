 ...
 * ```
 */
export declare function getCapacityBlockOfferingOutput(args: GetCapacityBlockOfferingOutputArgs, opts?: pulumi.InvokeOptions): pulumi.Output<GetCapacityBlockOfferingResult>;
/**
 * A collection of arguments for invoking getCapacityBlockOffering.
 */
