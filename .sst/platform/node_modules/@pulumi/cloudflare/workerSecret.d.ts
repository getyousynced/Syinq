 ...
 * ```
 */
export declare class WorkerSecret extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: WorkerSecretState, opts?: pulumi.CustomResourceOptions): WorkerSecret;
    /**
     * Returns true if the given object is an instance of WorkerSecret.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is WorkerSecret;
    /**
